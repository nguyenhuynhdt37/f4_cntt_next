...
// Tách phần client component để tránh vấn đề với React.use()
function DocumentViewClient({ id }: { id: string }) {
    ...
    export default function ViewDocumentPage({ params }: ViewDocumentPageProps) {
        // @ts-ignore - Bỏ qua cảnh báo về params là Promise
        const id = params.id;
        // Sử dụng DocumentViewClient để xử lý toàn bộ logic của component
        // return <DocumentViewClient id={id} />;
